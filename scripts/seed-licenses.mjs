...
const LICENSES = [
    {
        ...
        storageGb: 1, supportedApp: false, videoSource: 'limited', order: 0,
    ...
    },
    {
        ...
        storageGb: 5, supportedApp: true, videoSource: 'youtube', order: 1,
    ...
    },
    {
        ...
        storageGb: 20, supportedApp: true, videoSource: 'vimeo', order: 2,
    ...
    },
    {
        ...
        storageGb: 100, supportedApp: true, videoSource: 'vdocipher', order: 3,
