...
TARGET="${USER_B}@${HOST}"
FILES=(create.sh destroy.sh apply-license.sh apply-settings.sh update-site.sh apply-suspend.sh send_welcome.php apply_hero.php apply_about.php apply_gallery.php apply_contact.php provision-server.py setup-provision.sh)
