...
INTEGRATION_ENV_KEYS = {
    ...
    # Live + test sets.
    "KASHIER_LIVE_MERCHANT_ID", "KASHIER_LIVE_API_KEY", "KASHIER_LIVE_SECRET_KEY", "KASHIER_LIVE_BASE_URL", "KASHIER_LIVE_FEP_URL",
    "KASHIER_TEST_MERCHANT_ID", "KASHIER_TEST_API_KEY", "KASHIER_TEST_SECRET_KEY", "KASHIER_TEST_BASE_URL", "KASHIER_TEST_FEP_URL",
    "VDOCIPHER_APISECRET", "VDOCIPHER_APIBASE",
    "VIMEO_ACCESS_TOKEN", "VIMEO_APIBASE", "VIMEO_CLIENT_ID", "VIMEO_CLIENT_SECRET",
    "REVENUE_INGEST_URL", "REVENUE_INGEST_SECRET",
}
