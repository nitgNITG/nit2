...
const staticPages = [
    ...
    { path: "/our-services/school-management", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/our-services/educational-platforms", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/our-services/ai-educational-platforms", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/our-services/android-app", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/our-services/ios-app", priority: 0.9, changeFrequency: "monthly" as const },
    { path: "/our-services/website-design", priority: 0.9, changeFrequency: "monthly" as const },
