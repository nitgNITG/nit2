...
export const metadata: Metadata = {
    ...
    description: "شاهد أعمال الشركة الوطنية لهندسة البرمجيات: منصات Moodle التعليمية، تطبيقات التجارة الإلكترونية على Google Play وApp Store، ومنصات تعليمية متكاملة لمصر والخليج. خبرة 12+ سنة وأكثر من 100 مشروع ناجح.",
    ...
    openGraph: {
        ...
        description: "Explore N.I.T's portfolio: live Moodle LMS platforms, eCommerce apps on Google Play & App Store, and custom software solutions for Egypt and Gulf markets. 12+ years, 100+ projects.",
        type: "website",
        locale: "ar_EG",
