                ...
                <div className='flex-1 flex items-center justify-center relative z-10 pb-20'>
                    <div className='text-center space-y-6 max-w-3xl px-4'>
                        ...
                        <div>
                            <h1 className='text-xl md:text-2xl lg:text-3xl 2xl:text-5xl font-bold leading-tight drop-shadow-lg'>
                                ...
                                <span className='block mt-2' style={{ color: '#00FFCD' }}>
                                    {isAr ? 'تطبيقات التوصيل وطلب الخدمات' : 'On-Demand Delivery App Development'}
                                </span>
                            </h1>
                        </div>
                        ...
                        <p className='text-white/80 text-base md:text-lg font-medium max-w-xl mx-auto leading-relaxed drop-shadow' dir={isAr ? 'rtl' : 'ltr'}>
                            {isAr
                                ? 'نطوّر تطبيقات التوصيل وطلب الطعام على iOS وAndroid — مثل مرسول وهنقرستيشن وجاهز واوبر — توصيل طلبات وركاب بتتبع مباشر وتطبيق سائق ولوحة تحكم كاملة'
                                : 'Full delivery apps on iOS & Android — like Mrsool, HungerStation, Jahez & Uber — parcel & ride-hailing with live tracking, a driver app and a complete admin dashboard'}
                        </p>
                        ...
                        <div className='flex flex-wrap gap-8 justify-center pt-2'>
                            ...
                            <div className='w-px bg-white/20 self-stretch' />
                            <div className='text-center'>
                                <div className='text-lg md:text-xl 2xl:text-2xl font-bold drop-shadow' style={{ color: '#00FFCD' }}><CountUp end={3} suffix="+" /></div>
                                <div className='text-white/70 text-sm'>{isAr ? 'تطبيق توصيل' : 'Delivery apps'}</div>
                            </div>
                        </div>
