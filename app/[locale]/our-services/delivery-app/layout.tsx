...
export async function generateMetadata({
    ...
    return {
        title: isAr
            ? "تطوير تطبيقات التوصيل وطلب الطعام | N.I.T Egypt"
            : "Delivery App Development | N.I.T Egypt",
        description: isAr
        ...
        alternates: {
            canonical: `https://nitg-eg.com/${locale}/our-services/delivery-app`,
            languages: {
                ar: "https://nitg-eg.com/ar/our-services/delivery-app",
                en: "https://nitg-eg.com/en/our-services/delivery-app",
            },
        },
        openGraph: {
            ...
            url: `https://nitg-eg.com/${locale}/our-services/delivery-app`,
            type: "website",
            locale: isAr ? "ar_EG" : "en_US",
            images: [{ url: "https://nitg-eg.com/logo.svg", width: 512, height: 512, alt: "Delivery App Development — N.I.T Egypt" }],
        },
        twitter: {
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        url: "https://nitg-eg.com/en/our-services/delivery-app",
                    }),
                }}
            />
        </>
