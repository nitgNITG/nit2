...
const features = [
    {
        id: 1,
        title: 'Android Apps with Flutter',
        titleAr: 'تطبيقات أندرويد بـ Flutter',
        desc: 'High-performance apps built with Flutter from a single codebase that runs on Android & iOS.',
        descAr: 'تطبيقات عالية الأداء مبنية بـ Flutter بكود واحد يعمل على أندرويد و iOS.',
    },
    {
        id: 2,
        title: 'Material Design UI/UX',
        titleAr: 'تصميم واجهات Material',
        desc: 'Clean, modern interfaces following Google Material Design with full Arabic RTL support.',
        descAr: 'واجهات نظيفة وعصرية تتبع معايير Material Design مع دعم عربي كامل (RTL).',
    },
    {
        id: 3,
        title: 'Google Play Publishing',
        titleAr: 'النشر على Google Play',
        desc: 'We handle the full Google Play release, store listing optimization, and post-launch updates.',
        descAr: 'نتولّى النشر الكامل على Google Play وتحسين صفحة المتجر والتحديثات بعد الإطلاق.',
    },
    {
        id: 4,
        title: 'Push Notifications & Firebase',
        titleAr: 'الإشعارات و Firebase',
        desc: 'Firebase integration for push notifications, analytics, authentication and real-time data.',
        descAr: 'تكامل Firebase للإشعارات والتحليلات وتسجيل الدخول والبيانات اللحظية.',
    },
    {
        id: 5,
        title: 'Performance & Security',
        titleAr: 'الأداء والأمان',
        desc: 'Fast, secure apps with smooth animations, offline support and protected user data.',
        descAr: 'تطبيقات سريعة وآمنة مع حركات سلسة ودعم العمل دون إنترنت وحماية بيانات المستخدم.',
    },
]

const AndroidFeatures = async () => {
                    ...
                    <div className='space-y-10'>
                        <div className='space-y-3'>
                            <p className={clsx('text-sm text-gray-500', isAr ? 'text-right' : 'text-left')}>
                                {isAr ? 'تطبيقات الأندرويد' : 'Android · Mobile Apps'}
                            </p>
                            <div className={clsx('flex -space-x-5 lg:-space-x-8 items-center', isAr ? 'justify-start' : 'justify-end flex-row-reverse')}>
                                ...
                                <div className='z-10'>
                                    <h2 className='text-2xl md:text-3xl font-bold text-shadow'>
                                        {isAr
                                            ? <div className='m-4'>تصميم تطبيقات <span className='text-darkAquaMint'>الأندرويد</span></div>
                                            : <div className='m-4'>Android <span className='text-darkAquaMint'>App</span> Development</div>}
                                    </h2>
                                </div>
                                {!isAr && <div className='size-12 md:size-14 rotate-45 rounded-lg bg-aquaMint border-2 border-black' />}
                            </div>
