...
const WHATSAPP_MSG = encodeURIComponent('مرحباً، أريد الاستفسار عن تصميم تطبيق أندرويد')

const AndroidPricing = () => {
    ...
    useEffect(() => {
        axios.get('/api/plans?service=android')
            ...
            <div className='p-container space-y-10'>
                ...
                <div className='text-center space-y-3'>
                    ...
                    <h2 className='text-2xl md:text-3xl font-bold text-[#0B2923]'>
                        {isAr ? 'باقات تطبيقات الأندرويد' : 'Android App Packages'}
                    </h2>
