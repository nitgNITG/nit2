...
const AUDIENCE = [
    { icon: '🛍️', ar: 'المتاجر وسلاسل التجزئة', en: 'Retail Stores & Chains' },
    { icon: '🍽️', ar: 'المطاعم والكافيهات', en: 'Restaurants & Cafés' },
    { icon: '💈', ar: 'الصالونات ومراكز التجميل', en: 'Salons & Beauty Centers' },
    { icon: '🏋️', ar: 'الأندية ومراكز اللياقة', en: 'Gyms & Fitness Clubs' },
    { icon: '⛽', ar: 'محطات الوقود والخدمات', en: 'Fuel & Service Stations' },
    { icon: '🤝', ar: 'برامج الولاء المجتمعية', en: 'Community Loyalty Programs' },
]

const LoyaltyMarkets = async () => {
            ...
            <div className='p-container space-y-10'>
                <div className='text-center space-y-3'>
                    ...
                    <h2 className='text-2xl md:text-3xl font-bold text-[#0B2923]'>
                        {isAr ? 'من يحتاج نظام ولاء؟' : 'Who needs a loyalty system?'}
                    </h2>
                    <p className='text-gray-500 max-w-xl mx-auto text-sm'>
                        {isAr ? 'أي نشاط يريد عملاء يعودون ويشترون أكثر' : 'Any business that wants customers to return and buy more'}
                    </p>
                </div>
