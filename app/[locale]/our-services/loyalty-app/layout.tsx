...
export async function generateMetadata({
    ...
    return {
        title: isAr
            ? "تطوير أنظمة ولاء العملاء والنقاط والمكافآت | N.I.T Egypt"
            : "Customer Loyalty & Rewards App Development | N.I.T Egypt",
        description: isAr
        ...
        alternates: {
            canonical: `https://nitg-eg.com/${locale}/our-services/loyalty-app`,
            languages: {
                ar: "https://nitg-eg.com/ar/our-services/loyalty-app",
                en: "https://nitg-eg.com/en/our-services/loyalty-app",
            },
        },
        openGraph: {
            ...
            url: `https://nitg-eg.com/${locale}/our-services/loyalty-app`,
            type: "website",
            locale: isAr ? "ar_EG" : "en_US",
            images: [{ url: "https://nitg-eg.com/logo.svg", width: 512, height: 512, alt: "Customer Loyalty App Development — N.I.T Egypt" }],
        },
        twitter: {
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        url: "https://nitg-eg.com/en/our-services/loyalty-app",
                    }),
                }}
            />
        </>
