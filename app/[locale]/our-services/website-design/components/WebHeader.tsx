                ...
                <div className='flex-1 flex items-center justify-center relative z-10 pb-20'>
                    <div className='text-center space-y-6 max-w-3xl px-4'>
                        ...
                        <div>
                            <h1 className='text-xl md:text-2xl lg:text-3xl 2xl:text-5xl font-bold leading-tight drop-shadow-lg'>
                                ...
                                <span className='block mt-2' style={{ color: '#00FFCD' }}>
                                    {isAr ? 'تصميم مواقع الإنترنت' : 'Design & Development'}
                                </span>
                            </h1>
                        </div>
                        ...
                        <p className='text-white/80 text-base md:text-lg font-medium max-w-xl mx-auto leading-relaxed drop-shadow'>
                            {isAr
                                ? 'شركة تطوير وبرمجة مواقع إنترنت احترافية — مواقع شركات وصفحات هبوط وتطبيقات ويب متجاوبة وسريعة ومهيأة لمحركات البحث'
                                : 'Professional web development company — corporate sites, landing pages and web apps that are responsive, fast and SEO-ready'}
                        </p>

                        <div className='flex flex-wrap gap-8 justify-center pt-2'>
                            <div className='text-center'>
                                <div className='text-lg md:text-xl 2xl:text-2xl font-bold drop-shadow' style={{ color: '#00FFCD' }}>{isAr ? 'متجاوب' : 'Responsive'}</div>
                                <div className='text-white/70 text-sm'>{isAr ? 'كل الشاشات' : 'All Devices'}</div>
                            </div>
                            <div className='w-px bg-white/20 self-stretch' />
                            <div className='text-center'>
                                <div className='text-lg md:text-xl 2xl:text-2xl font-bold drop-shadow' style={{ color: '#00FFCD' }}>SEO</div>
                                <div className='text-white/70 text-sm'>{isAr ? 'مهيأ للبحث' : 'Search-Ready'}</div>
                            </div>
                            <div className='w-px bg-white/20 self-stretch' />
                            <div className='text-center'>
