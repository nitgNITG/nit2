...
const WHATSAPP_MSG = encodeURIComponent('مرحباً، أريد الاستفسار عن تصميم موقع إنترنت')
...
const WebPricing = () => {
    ...
    useEffect(() => {
        axios.get('/api/plans?service=web')
            ...
            <div className='p-container space-y-10'>
                ...
                <div className='text-center space-y-3'>
                    ...
                    <h2 className='text-2xl md:text-3xl font-bold text-[#0B2923]'>
                        {isAr ? 'باقات تصميم المواقع' : 'Website Packages'}
                    </h2>
