                    ...
                    <div className='text-center space-y-6 max-w-3xl px-4'>
                        ...
                        <div className='flex justify-center'>
                            <span className='inline-flex items-center gap-2 border border-[#268F79] text-[#00FFCD] text-xs font-semibold tracking-widest uppercase px-4 py-2 rounded-full bg-[#268F79]/10 backdrop-blur-sm'>
                                ...
                                {isAr ? 'تطبيقات المطاعم' : 'Restaurant Apps'}
                            </span>
                        </div>
                        ...
                        <div>
                            <h1 className='text-xl md:text-2xl lg:text-3xl 2xl:text-5xl font-bold leading-tight drop-shadow-lg'>
                                ...
                                <span className='block mt-2' style={{ color: '#00FFCD' }}>
                                    {isAr ? 'تطبيقات وأنظمة المطاعم' : 'Restaurant App Development'}
                                </span>
                            </h1>
                        </div>
                        ...
                        <p className='text-white/80 text-base md:text-lg font-medium max-w-xl mx-auto leading-relaxed drop-shadow' dir={isAr ? 'rtl' : 'ltr'}>
                            {isAr
                                ? 'تصميم و برمجة تطبيق مطعم على iOS وAndroid — تطبيق طلب ودليفري باسم مطعمك مع نظام إدارة مطعم متكامل، قوائم رقمية، ونقاط بيع POS'
                                : 'Restaurant ordering & delivery apps on iOS & Android with a full restaurant management system, digital menus and POS'}
                        </p>
                        ...
                        <div className='flex flex-wrap gap-8 justify-center pt-2'>
                            ...
                            <div className='w-px bg-white/20 self-stretch' />
                            <div className='text-center'>
                                <div className='text-lg md:text-xl 2xl:text-2xl font-bold drop-shadow' style={{ color: '#00FFCD' }}>POS</div>
                                <div className='text-white/70 text-sm'>{isAr ? 'نقاط بيع' : 'Point of sale'}</div>
                            </div>
                        </div>
