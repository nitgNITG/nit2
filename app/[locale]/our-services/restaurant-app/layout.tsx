...
export async function generateMetadata({
    ...
    return {
        title: isAr
            ? "تطوير تطبيقات المطاعم ونظام إدارة المطعم | N.I.T Egypt"
            : "Restaurant App Development | N.I.T Egypt",
        description: isAr
        ...
        alternates: {
            canonical: `https://nitg-eg.com/${locale}/our-services/restaurant-app`,
            languages: {
                ar: "https://nitg-eg.com/ar/our-services/restaurant-app",
                en: "https://nitg-eg.com/en/our-services/restaurant-app",
            },
        },
        openGraph: {
            ...
            url: `https://nitg-eg.com/${locale}/our-services/restaurant-app`,
            type: "website",
            locale: isAr ? "ar_EG" : "en_US",
            images: [{ url: "https://nitg-eg.com/logo.svg", width: 512, height: 512, alt: "Restaurant App Development — N.I.T Egypt" }],
        },
        twitter: {
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        url: "https://nitg-eg.com/en/our-services/restaurant-app",
                    }),
                }}
            />
        </>
