...
export default function MoodlePage() {
    return (
        <div className='overflow-y-hidden'>
            ...
            <BreadcrumbsJsonLd items={[{ path: 'our-services/moodle-lms', ar: 'تطوير منصات Moodle', en: 'Moodle LMS Development' }]} />
            <MoodleHeader />
            <ScrollReveal><MoodleFeatures /></ScrollReveal>
            <ScrollReveal><MoodleMarkets /></ScrollReveal>
            <ScrollReveal><ServiceOfferings service="moodle" /></ScrollReveal>
