...
export async function generateMetadata({
    ...
    return {
        title: "إنشاء منصة تعليمية | Moodle LMS Development | N.I.T Egypt",
        description: isAr
        ...
        alternates: {
            canonical: `https://nitg-eg.com/${locale}/our-services/moodle-lms`,
            languages: {
                ar: "https://nitg-eg.com/ar/our-services/moodle-lms",
                en: "https://nitg-eg.com/en/our-services/moodle-lms",
            },
        },
        openGraph: {
            ...
            url: `https://nitg-eg.com/${locale}/our-services/moodle-lms`,
            type: "website",
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        url: "https://nitg-eg.com/en/our-services/moodle-lms",
                    }),
                }}
            />
        </>
