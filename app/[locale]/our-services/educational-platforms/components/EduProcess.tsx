...
const steps = [
    ...
    },
    {
        ...
        descAr: 'نصمم هوية المنصة وتجربة المستخدم ونخطط بنية المقررات والصلاحيات والميزات المطلوبة.',
        descEn: 'We design the platform identity and UX, and plan the course structure, roles, and required features.',
    },
    {
        titleAr: 'التطوير والتكامل',
        titleEn: 'Development & Integration',
        descAr: 'نطوّر المنصة، نطبّق التصميم، ونكامل البث المباشر وأنظمة الاختبارات مع دعم عربي RTL كامل.',
        descEn: 'We build the platform, apply the theme, and integrate live streaming and assessment systems with full Arabic RTL support.',
    },
    {
            ...
            <div className='p-container space-y-10'>
                <div className='text-center space-y-3'>
                    ...
                    <h2 className='text-2xl md:text-3xl font-bold text-[#0B2923]'>
                        {isAr ? 'كيف نطوّر منصتك التعليمية خطوة بخطوة' : 'How We Build Your Educational Platform — Step by Step'}
                    </h2>
