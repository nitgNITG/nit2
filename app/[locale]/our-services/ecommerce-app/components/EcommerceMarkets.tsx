            ...
            <div className='p-container space-y-12'>
                ...
                <div className='text-center space-y-3'>
                    ...
                    <h2 className='text-2xl md:text-3xl font-bold text-[#0B2923]'>
                        {isAr ? 'من يستفيد من متجر إلكتروني؟' : 'Who benefits from an eCommerce store?'}
                    </h2>
                    <p className='text-gray-500 max-w-xl mx-auto text-sm'>
                        {isAr ? 'من القاهرة إلى الرياض — نبني متاجر إلكترونية وتطبيقات جوال تناسب سوقك' : 'From Cairo to Riyadh — We build eCommerce and mobile apps that fit your market'}
                    </p>
                </div>
                ...
                <div className='bg-[#0B2923] rounded-2xl p-6 md:p-8'>
                    <h3 className='text-white font-bold text-center text-lg mb-6'>{isAr ? 'كل متجر يشمل بالأساس' : 'Every store basically includes'}</h3>
