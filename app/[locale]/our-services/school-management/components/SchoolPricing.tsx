...
const WHATSAPP_MSG = encodeURIComponent('مرحباً، أريد الاستفسار عن نظام إدارة المدارس')
...
const SchoolPricing = () => {
    ...
    useEffect(() => {
        axios.get('/api/plans?service=school')
            ...
            <div className='p-container space-y-10'>
                ...
                <div className='text-center space-y-3'>
                    ...
                    <h2 className='text-2xl md:text-3xl font-bold text-[#0B2923]'>
                        {isAr ? 'باقات نظام إدارة المدارس' : 'School Management Packages'}
                    </h2>
                    <p className='text-gray-500 text-sm'>
                        {isAr
                            ? 'الأسعار تبدأ من — السعر النهائي يعتمد على متطلبات مدرستك'
                            : 'Starting from — final price depends on your school requirements'}
                    </p>
                </div>
                ...
                <p className='text-center text-xs text-gray-400'>
                    {isAr
                        ? '* جميع الباقات تشمل ضمان سنة وتدريب الفريق. تواصل معنا لعرض سعر مخصص لمدرستك.'
