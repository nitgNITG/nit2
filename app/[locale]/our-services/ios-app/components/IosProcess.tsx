...
const steps = [
    ...
    },
    {
        ...
        descAr: 'نصمم واجهات التطبيق وفق معايير Apple (HIG) بتجربة استخدام راقية.',
        descEn: 'We design the app interfaces following Apple HIG with a premium user experience.',
    },
    {
    ...
    },
    {
        ...
        titleEn: 'Testing & QA',
        descAr: 'نختبر الأداء والأمان على أجهزة آيفون وآيباد مختلفة لضمان استقرار التطبيق.',
        descEn: 'We test performance and security on multiple iPhone and iPad devices to ensure stability.',
    },
    {
        titleAr: 'النشر على App Store',
        titleEn: 'App Store Publishing',
        descAr: 'نرفع التطبيق ونجتاز مراجعة Apple وننشره على App Store نيابة عنك.',
        descEn: 'We submit the app, pass Apple review, and publish it to the App Store on your behalf.',
    },
    {
            ...
            <div className='p-container space-y-10'>
                <div className='text-center space-y-3'>
                    ...
                    <h2 className='text-2xl md:text-3xl font-bold text-[#0B2923]'>
                        {isAr ? 'كيف نطوّر تطبيق الآيفون خطوة بخطوة' : 'How We Build Your iPhone App — Step by Step'}
                    </h2>
                    <p className='text-gray-500 text-sm max-w-2xl mx-auto'>
                        {isAr
                            ? 'منهجية واضحة من أول استشارة حتى النشر على App Store والدعم, تستغرق عادة من 6 إلى 14 أسبوعاً حسب التعقيد.'
                            : 'A clear methodology from first consultation to App Store publishing and support — typically 6 to 14 weeks depending on complexity.'}
                    </p>
                </div>
