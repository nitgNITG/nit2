...
const EG_CLIENTS = [
    ...
    { icon: '💎', ar: 'العلامات التجارية الفاخرة', en: 'Premium & Luxury Brands' },
    ...
    { icon: '💪', ar: 'تطبيقات اللياقة والصحة', en: 'Fitness & Health Apps' },
];

const GULF_CLIENTS = [
    { icon: '🏢', ar: 'الشركات والمؤسسات', en: 'Companies & Enterprises' },
    { icon: '🛍️', ar: 'متاجر التجزئة الفاخرة', en: 'Premium Retail Stores' },
    { icon: '💼', ar: 'الخدمات المهنية', en: 'Professional Services' },
    { icon: '🏨', ar: 'الفنادق والضيافة', en: 'Hotels & Hospitality' },
    { icon: '💰', ar: 'الخدمات المالية والبنوك', en: 'Finance & Banking' },
    { icon: '🏘️', ar: 'العقارات', en: 'Real Estate' },
];

const FEATURES_COMMON = [
    { icon: '📱', ar: 'تطبيق مبني بـ Flutter', en: 'Built with Flutter' },
    { icon: '🎨', ar: 'تصميم وفق معايير Apple', en: 'Apple HIG Design' },
    { icon: '🍏', ar: 'تكامل Apple Pay', en: 'Apple Pay Integration' },
    { icon: '🌐', ar: 'دعم عربي وإنجليزي', en: 'Arabic & English Support' },
    { icon: '🔔', ar: 'إشعارات فورية', en: 'Push Notifications' },
    { icon: '🛒', ar: 'النشر على App Store', en: 'App Store Publishing' },
];

const IosMarkets = async () => {
            ...
            <div className='p-container space-y-12'>
                ...
                <div className='text-center space-y-3'>
                    ...
                    <h2 className='text-2xl md:text-3xl font-bold text-[#0B2923]'>
                        {isAr ? 'من يحتاج تطبيق آيفون؟' : 'Who needs an iPhone app?'}
                    </h2>
                    <p className='text-gray-500 max-w-xl mx-auto text-sm'>
                        {isAr ? 'من القاهرة إلى الرياض — نبني تطبيقات آيفون تناسب نشاطك وسوقك' : 'From Cairo to Riyadh — We build iPhone apps that fit your business and market'}
                    </p>
                </div>
